...
(function () {
  ...
  const DICT = [
    ...
    { sel: '.hero-badge', en: '✓ 24×7 Support on WhatsApp', hi: '✓ व्हाट्सऐप पर 24×7 सहायता', bn: '✓ হোয়াটসঅ্যাপে ২৪×৭ সহায়তা', or: '✓ ୱାଟ୍ସଆପରେ ୨୪×୭ ସହାୟତା' },
