    ...
    mailTransporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: #1e293b; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 8px; padding: 24px;">
          ...
          <p>Our travel experts are finding a great rate for you. We'll contact you on <strong>${userPhone}</strong> (${contactMethod || 'your preferred method'}) during our expert hours — <strong>every day, 11am to 3pm</strong>.</p>
